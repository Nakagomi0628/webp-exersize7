...
let evilCircle = new EvilCircle(random(0 + random(10,20),width - random(10,20)),random(0 + random(10,20),height - random(10,20)),true);
...
function loop() {
  ...
  for(let i = 0; i < balls.length; i++) {
    ...
    cnt.innerHTML = balls.length - ballCnt;
  }
